...
var colorSets6 = readColorsTxt("color-sets/colors_mcd20_mld2_nc6_cvd100_minj40_maxj90_ns10000_hcl_sorted.txt")
var lenColorSets6 = int32(len(colorSets6))
var colorSets8 = readColorsTxt("color-sets/colors_mcd18_mld2_nc8_cvd100_minj40_maxj90_ns10000_hcl_sorted.txt")
var lenColorSets8 = int32(len(colorSets8))
var colorSets10 = readColorsTxt("color-sets/colors_mcd16_mld2_nc10_cvd100_minj40_maxj90_ns10000_hcl_sorted.txt")
var lenColorSets10 = int32(len(colorSets10))

// Repeat after 50 responses
var repeatCount = 50
...
func colors(w http.ResponseWriter, r *http.Request) {
	...
	// Pick next two color sets
	ra := rand.New(rand.NewSource(int64(picks%repeatCount)))
	numColors := 8
	var cycle1 []string
	var cycle2 []string
	cycle1 = append([]string(nil), colorSets8[ra.Int31n(lenColorSets8)]...)
	cycle2 = append([]string(nil), colorSets8[ra.Int31n(lenColorSets8)]...)

	// Randomly generate four permutations
	orders := [][]int{ra.Perm(numColors), ra.Perm(numColors), ra.Perm(numColors), ra.Perm(numColors)}
